...
function setup() {
  ...
  distanceSlider = createSlider(0, 10.0, 0.5, 0.5); // Distance between the slits in microns
  ...
  distanceSlider.parent('canvasContainer');
...
//     slitWidthSlider.style("accent-color", color); // Set thumb color to black
  ...
  if (waveOffset < height / 20) {
    waveOffset += 1.5; // Adjust speed of the wavefront animation
    waveOffsetShift -= 1;
  } else {
    waveOffset = 0;
    waveOffsetShift = 140;
